...
test("summary computes win rate, median delta, availability and latency percentiles", () => {
  const base = benchmarkRecord({ enabled: true, request: buy(), best: null, alternatives: [], diagnostics: [], route: null,
      splitReason: null, path: null, pathReason: null, exclusions: [], quotedAt: "", slot: null, latencyMs: {} });

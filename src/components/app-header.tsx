...
import { ArrowLeftRight, ArrowRight, Box, ChartNoAxesCombined, ChevronDown, LogOut, Sprout, User, Wallet } from "lucide-react";
import { HenarBrand } from "./henar-brand";
import { RewardsMenu } from "./rewards-menu";
import { ThemeToggle } from "./theme-toggle";

/* Studio is deliberately absent. Henar is a marketplace for equities that
   already exist; Studio launches new bonding-curve markets, which is a
   different job for a different person, and putting it in an investor's
   navigation made the product read as two products. The route still exists
   behind its flag for operators and as a record of the Meteora DBC work. */
const navigation = [
